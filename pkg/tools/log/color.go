...
var (
	...
	_levelToLowercaseString = make(map[zapcore.Level]string, len(_levelToColor))
	_levelToCapitalString   = make(map[zapcore.Level]string, len(_levelToColor))
)
...
func init() {
	for level, color := range _levelToColor {
		...
		_levelToLowercaseString[level] = level.String()
		_levelToCapitalString[level] = level.CapitalString()
	}
}
